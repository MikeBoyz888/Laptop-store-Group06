								...
								<table class="shop_table cart">
									...
									<tbody>
										...
										<tr class="cart_item">
											...
											<td class="product-name"><a href="single-product.jsp"><%=c.getName()%></a></td>

											<td class="product-price"><span class="amount"><%=format.format(c.getPrice())%></span>
											</td>

											<td class="product-quantity">
												<div class="quantity buttons_added">
													<a href="QuantityIncDecServlet?action=dec&id=<%=c.getId()%>"><input
														type="button" class="minus" value="-"></a> 
													<input type="number" size="4" class="input-text qty text"
														title="Qty" value="<%=c.getQuantity()%>" min="0" step="1">
													<a href="QuantityIncDecServlet?action=inc&id=<%=c.getId()%>"><input
														type="button" class="plus" value="+"></a>
												</div>
											</td>

											<td class="product-subtotal"><span class="amount"><%=format.format(c.getPrice()*c.getQuantity())%></span>
											</td>
										</tr>
										<%}
										}%>
